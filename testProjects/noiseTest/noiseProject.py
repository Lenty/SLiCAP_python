...
plotNoise('onoise', 'Detector-refferred noise', noiseResults, 0.1, '1M', 200, noise='onoise', sources = 'all')
...
plotNoise('inoiseStepped', 'Source-refferred noise', noiseResultsStepped, 0.1, '1M', 200, noise='inoise', sources = 'I1')
