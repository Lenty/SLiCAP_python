...
SYMATTR SpiceModel ?
SYMATTR Value W_N={W_N} L_N={L_N} ID_N={ID_N} W_P={W_P} L_P={L_P} ID_P={ID_P}
SYMATTR Prefix X
SYMATTR Description sub circuit small-signal complementary-parallel MOS stage (EKV model in saturation region)
PIN 48 -48 NONE 0
PINATTR PinName D
