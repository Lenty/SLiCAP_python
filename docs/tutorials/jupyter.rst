...
- `myFirstRCnetwork <../../files/examples/myFirstRCnetwork/myFirstRCnetwork.zip>`_

  This is a basic tutorial; the *Hello world* of SLiCAP.

- `MOSparams <../../files/examples/MOSparams/MOSparams.zip>`_

  This tutorial shows how to plot parameters against each other.

- `CSstage  <../../files/examples/CSstage/CSstage.zip>`_
...
- `FilterDesign <../../files/examples/FilterDesign/FilterDesign.zip>`_
